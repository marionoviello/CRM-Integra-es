...
ESCOPOS: dict[str, dict[str, str]] = {
    "aereo_consumidor": {
        ...
        "descricao_honorarios": (
            "Honorários iniciais (pro labore e de custeio administrativo): "
            "quantia fixa, única e irrepetível de R$ {{VALOR_HONORARIOS}} "
            "({{VALOR_HONORARIOS_EXTENSO}}), devida pela aceitação do "
            "mandato, pela consultoria jurídica especializada inicial, pela "
            "análise aprofundada dos documentos e fatos do caso, pela "
            "elaboração das peças processuais inaugurais ou notificações "
            "extrajudiciais, e pela abertura do procedimento administrativo "
            "e/ou judicial. O pagamento deverá ser efetuado no ato da "
            "assinatura do presente contrato, servindo o comprovante de "
            "transferência bancária ou PIX como recibo e condição de "
            "eficácia do início da atuação profissional. Honorários de êxito "
            "(ad exitum): o percentual de 35% (trinta e cinco por cento) "
            "sobre o proveito econômico bruto total que o CONTRATANTE "
            "auferir em decorrência da atuação do CONTRATADO. O proveito "
            "econômico total para fins de cálculo deste percentual "
            "compreende a integralidade dos valores recebidos, sejam eles "
            "decorrentes de indenização por danos morais, indenização por "
            "danos materiais (incluindo ressarcimento de despesas, lucros "
            "cessantes e danos emergentes), reembolso de passagens ou "
            "serviços, valores oriundos de acordos judiciais ou "
            "extrajudiciais, ou qualquer outra verba pecuniária obtida em "
            "função direta ou indireta do trabalho realizado. Os honorários "
            "de sucumbência, quando houver condenação da parte adversa ao "
            "pagamento, pertencerão integralmente ao CONTRATADO, conforme "
            "previsão do Estatuto da Advocacia, não se confundindo com os "
            "honorários de êxito contratuais estabelecidos neste "
            "instrumento, que incidem sobre o proveito econômico do "
            "CONTRATANTE."
        ),
    },
    "urbanistico_iptu_regularizacao": {
